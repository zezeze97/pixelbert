...
from src.modeling.modeling import PixelBertForSequenceClassification
from src.modeling.e2e_model import PixelBertWithResNet50GCB

from src.datasets.dataset_vqa import PixelBertVQADataset, VQACollator
...
def mk_vqa_dataloader(anno_path, img_lmdb_dir, cfg, tokenizer, is_train=True):
    ...
    dataset = PixelBertVQADataset(datalist=group_datalist,
                                 tokenizer=tokenizer,
...
def setup_model(cfg, device=None):
    ...
    model = PixelBertWithResNet50GCB(
        model_cfg, input_format=cfg.img_input_format,
        transformer_cls=PixelBertForSequenceClassification)
