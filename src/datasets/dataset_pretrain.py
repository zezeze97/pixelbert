...
from src.datasets.dataset_base import PixelBertBaseDataset, img_collate


class PixelBertPretrainDataset(PixelBertBaseDataset):
    """
    ...
    def __init__(self, datalist, tokenizer, img_lmdb_dir,
        ...
        super(PixelBertPretrainDataset, self).__init__(
...
class PretrainCollator(object):
    ...
    def collate_batch(self, batch):
        ...
        return dict(
            visual_inputs=visual_inputs,  # (B, H, W, C)
